...
public class BigController implements Controller {
	...
	public void start() {
		...
		selection4 = view.addSelection("Ben Vorlich");
	...
	public void select(int selectionID) {
		...
		// create a picture corresponding to the selectionID and add a fourth
		if (selectionID==selection1) {
			...
			picture = service.getPicture("Ben Vorlich", 1);
		}
		// show the picture in the interface
		view.showPicture(picture);
	}
}
// end of BigController